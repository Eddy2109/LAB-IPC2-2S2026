...
namespace IntroProyecto1
{
    class MatrizOrtogonal
    {
        ...
        public void Graficar()
        {
            ...
            dot.AppendLine("  MiMatriz [label=<");
            dot.AppendLine("  <TABLE BORDER=\"0\" CELLBORDER=\"1\" CELLSPACING=\"0\" cellpadding=\"10\">");

            while (fila != null)
            {
                dot.AppendLine("    <tr>");
                dot.AppendLine($"        <td>{fila.fila}</td>");
                ...
                // recorro las columnas fila.abajo
                fila = fila.abajo;
                dot.AppendLine("    </tr>");
            }
